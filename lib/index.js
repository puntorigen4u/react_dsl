  ...
  **/
  class base_ui {
    constructor() {
      ...
      this.context.x_state.ui = _objectSpread2(_objectSpread2({}, this.context.x_state.ui), {
        'textTag': 'div',
        'viewNPM': '',
        bold: {
          //attributes get merged on textTags (if no class defined)
    ...
    generateAutoComplete() {
      var _this2 = this;
      return _asyncToGenerator(function* () {
        var auto = yield _this2.autocomplete();
        for (var key in auto) {
          yield _this2.context.addAutocompleteDefinition(auto[key]);
        }
      })();
    }
    defaultState() {
  ...
  class mui extends base_ui {
    ...
    generateFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        default_theme = _this4.deepMerge(default_theme, _this4.context.x_state.theme);
    ...
    autocomplete() {
      return _asyncToGenerator(function* () {
        ...
        return [{
          text: 'Button',
          type: 'system',
          // system, component (user, gets erased on each cache clear) - refers to a subfolder on .autocomplete
          icons: ['idea'],
          level: [3, 4, 5, 6, 7, 8],
    ...
    */
    ...
    createSystemFiles() {
      ...
      return _asyncToGenerator(function* () {
        require('path');
        var g = _this17.g;
        yield _this17.x_theme.generateFiles();
        ...
        var globalsCSS = yield _this17.x_theme.globalCSS();
        _this17.writeFile(g('@styles/globals.css'), globalsCSS);
        ...
        //
        var indexHeadTheme = yield _this17.x_theme.indexHtmlHead();
