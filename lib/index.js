  ...
  var autocomplete$1 = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (parent) {
      ...
      var types = {
        ...
        type: 'system',
        colors: ['primary', 'secondary', 'tertriary', 'success', 'action', 'disabled'],
        sizes: ['lg', 'md', 'sm', 'xs'],
          ...
          ["def_icon_".concat(style.toLowerCase())]: {
            ...
            func: function () {
              var _func = _asyncToGenerator(function* (node, state) {
                ...
                var icon = node.text.replace("icon:".concat(style, ":"), '');
                var attrs = {
                  refx: node.id
                };
  ...
  class react_dsl extends concepto {
    ...
    processInternalTags(react, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (nodes.length > 0) _this12.debug('post-processing def_param tags', react.template);
        var self = _this12;
