  ...
  class react_dsl extends concepto {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (page) {
          ...
          if (page.xtitle || page.meta.length > 0 || page.link.length > 0) {
            ...
            // define title
            if (page.xtitle) {
              if (_this11.x_state.central_config.idiomas.indexOf(',') != -1) {
                // i18n title
                var crc32 = "t_".concat(yield _this11.hash(page.xtitle));
                var def_lang = _this11.x_state.central_config.idiomas.indexOf(',')[0].trim().toLowerCase();
                ...
                // normal title
                vue.script += "titleTemplate: ".concat(_this11.jsDump(page.xtitle), "\n");
              }
            }
            // define meta SEO
      ...
      return _asyncToGenerator(function* () {
        ...
        var g = file => {
          ...
          if (file[0] == '@') {
            ...
            if (base in _this17.x_state.dirs) {
              res = path.join(_this17.x_state.dirs[base], withoutBase);
            }
          }
          return res;
        };
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        yield _this27.createNuxtPlugins(false);
        ...
        for (var thefile_num in processedNodes) {
          ...
          var toDisk = /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator(function* (thefile) {
              ...
              react.full = "".concat(react.template, "\n").concat(react.script, "\n").concat(react.style);
              // ********************************** //
              // write files
          ...
          //
          if (thefile.file.split('.').slice(-1) == 'omit') ; else if (thefile.file.includes('.group') == true) {
            yield* function* () {
              ...
              _this27.debug('processing group ' + thefile.file + ' of files', thefile);
              var cheerio = require('cheerio');
              var $ = cheerio.load(thefile.code, {
                ignoreWhitespace: false,
                xmlMode: true,
