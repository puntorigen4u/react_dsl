  ...
  **/
  ...
  class mui extends base_ui {
    ...
    autocomplete() {
      ...
      return _asyncToGenerator(function* () {
        // insert associated ui autocompletion calls here
        yield _this3.context.addAutocompleteDefinition({
          text: 'AppBar',
          icons: ['idea'],
          level: [3, 4],
          hint: 'Top navigation bar',
    ...
    generateFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        default_theme = _this5.deepMerge(default_theme, _this5.context.x_state.theme);
  ...
  class react_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        yield _this3.x_theme.autocomplete(); // add autocomplete definitions
