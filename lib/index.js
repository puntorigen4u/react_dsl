    ...
    */
    ...
    createSystemFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        default_theme = deepMerge(default_theme, _this17.x_state.theme);
        material_theme = material_theme.replaceAll('{concepto:theme}', _this17.jsDump(default_theme));
        _this17.writeFile(g('@theme/theme.js'), material_theme);
        //create index.js
    ...
    _readTheme() {
      ...
      return _asyncToGenerator(function* () {
        var resp = {
          ...
          require('path');
        _this30.debug('_readTheme');
        _this30.debug_time({
          id: '_readTheme'
        });
        var theme = yield _this30.dsl_parser.getNodes({
          text: 'theme',
          level: 2,
          icon: 'desktop_new',
          recurse: true
    ...
    _readCentralConfig() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (resp['ui'] == 'mui') {
          ...
          // just a demo for now
          yield _this32.addAutocompleteDefinition({
            text: 'AppBar',
            icons: ['idea'],
            level: [3, 4],
        ...
        if (resp['ui'] == 'mui') {
          _this32.x_state.ui = _objectSpread2(_objectSpread2(_objectSpread2({}, _this32.x_state.ui), uiDefaultState), {
            'textTag': 'Typography',
    ...
    _readConfig() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (search.length > 0) {
          ...
          var central2 = JSON.parse(JSON.stringify(_this33.x_state.central_config));
        ...
        if (!resp.name) {
          ...
          resp.name = folder.replace('/', '').replace('\\', '') + '_' + path.basename(_this33.x_flags.dsl, '.dsl');
