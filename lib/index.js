  ...
  **/
  ...
  var autocomplete$1 = () => {
    ...
    var types = {
      ...
      type: 'system',
      colors: ['primary', 'secondary', 'tertriary'],
      sizes: ['lg', 'md', 'sm', 'xs'],
      ...
      return _asyncToGenerator(function* () {
        ...
        nodes.map(function (elem) {
          ...
          for (var _key2 in value) {
            ...
            if (value[_key2].length > 2 && value[_key2][0] == '{' && value[_key2][value[_key2].length - 1] == '}') {
              var tmp = value[_key2].replace('{', '').replace('}', '');
              if (tmp in special_x) {
                value[_key2] = special_x[tmp];
                //delete value[tmp];
              }
            }
          }
