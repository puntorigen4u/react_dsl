  ...
  class react_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this3.x_state.npm['@emotion/react'] = '^11.10.5';
        _this3.x_state.npm['@emotion/styled'] = '^11.10.5';
        _this3.x_state.npm['@fontsource/roboto'] = '^4.5.8';
        _this3.x_state.npm['@mui/icons-material'] = '^5.10.14';
        _this3.x_state.npm['@mui/material'] = '^5.10.14';
        _this3.x_state.npm['normalize.css'] = '^8.0.1';
      ...
      return _asyncToGenerator(function* () {
        ...
        if (deploy) {
          ...
          if (deploy.includes('eb:')) {
            ...
            _this5.deploy_module = new remote({
              context: _this5
            });
          } else if (deploy == 'ghpages') {
            _this5.deploy_module = new ghpages({
              context: _this5
            });
          } else ;
        }
    ...
    generalConfigSetup() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this7.debug('Setting general configuration steps');
        ...
        if (_this7.x_state.central_config['langs'].indexOf(',') != -1) {
          _this7.debug('Defining react-i18n support : module react-i18next (langs)');
          _this7.x_state.npm['i18next'] = '*';
          _this7.x_state.nuxt_config.modules['i18next'] = {
            'defaultLocale': _this7.x_state.central_config['langs'].split(',')[0],
            'vueI18n': {
              'fallbackLocale': _this7.x_state.central_config['langs'].split(',')[0]
            },
          ...
          var self = _this7;
          _this7.x_state.central_config['langs'].split(',').map(function (lang) {
            if (lang == 'es') {
    ...
    processOmitFile(thefile) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (thefile.file == 'internal_stores.omit') {
          _this9.debug('processing internal_stores.omit');
        ...
        if (thefile.file == 'internal_middleware.omit') {
          _this9.debug('processing internal_middleware.omit');
        ...
        if (thefile.file == 'server.omit') {
          _this9.debug('processing server.omit');
    ...
    getComponentStory(thefile) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var page = _this10.x_state.pages[thefile.title];
        ...
        if (page) {
          if (page.type == 'component' && page.params != '') {
            ...
            js.script += "export default {\n                    title: '".concat(camel(_this10.x_state.central_config.apptitle, {
              pascalCase: true
      ...
      return _asyncToGenerator(function* () {
        ...
        if (page) {
          ...
          if (page.proxies.indexOf(',') != -1) {
            _this11.debug('- declare middlewares');
          ...
          // declare components
          if (page.components != '') {
            _this11.debug('- declare components');
            if (react.first) react.script += ',\n';
            react.first = true;
          ...
          // declare directives
          if (page.directives != '') {
            _this11.debug('- declare directives');
            if (react.first) react.script += ',\n';
            react.first = true;
          ...
          if (page.type == 'component' && page.params != '') {
            _this11.debug('- declare component:props');
            if (react.first) react.script += ',\n';
            react.first = true;
            var isNumeric = function isNumeric(n) {
              return !isNaN(parseFloat(n)) && isFinite(n);
          ...
          if (page.xtitle || page.meta.length > 0 || page.link.length > 0) {
            _this11.debug('- declare head() meta data');
            if (react.first) react.script += ',\n';
            react.first = true;
            react.script += " head() {\n return {\n";
            // define title
            if (page.xtitle) {
              if (_this11.x_state.central_config.langs.indexOf(',') != -1) {
                // i18n title
                var crc32 = "t_".concat(yield _this11.hash(page.xtitle));
                var def_lang = _this11.x_state.central_config.langs.indexOf(',')[0].trim().toLowerCase();
                if (!_this11.x_state.strings_i18n[def_lang]) {
                  _this11.x_state.strings_i18n[def_lang] = {};
                }
                _this11.x_state.strings_i18n[def_lang][crc32] = page.xtitle;
                react.script += "titleTemplate: this.$t('".concat(crc32, "')\n");
              } else {
                // normal title
                react.script += "titleTemplate: ".concat(_this11.jsDump(page.xtitle), "\n");
              }
            }
            // define meta SEO
            if (page.meta.length > 0) {
              ...
              react.script += "meta: ".concat(_this11.jsDump(page.meta), "\n");
            }
            // define head LINK
          ...
          if (Object.keys(page.variables) != '') {
            _this11.debug('- declare data() variables');
            var camel = require('camelcase');
            if (react.first) react.script += ',\n';
            react.first = true;
            console.log(page.variables);
            for (var key in page.variables) {
              var def_val = page.variables[key] ? _this11.jsDump(page.variables[key]) : "''";
            ...
            //react.script += `}\n`;
            _this11.debug('- declare data() variables dump', react.variables);
    ...
    processInternalTags(vue, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (nodes.length > 0) _this12.debug('post-processing server_asyncdata tag');
        ...
        if (nodes.length > 0) _this12.debug('post-processing vue_mounted tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        if (nodes.length > 0) _this12.debug('post-processing vue_created tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        if (nodes.length > 0) _this12.debug('post-processing vue_computed tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        if (nodes.length > 0) _this12.debug('post-processing vue_async_computed tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        for (var x of [1, 2, 3, 4, 5]) {
          ...
          if (nodes.length > 0) {
            _this12.debug("post-processing vue_if tag ".concat(x, " (len:").concat(nodes.length, ")"));
            nodes.map(function (elem) {
              var cur = $(elem);
        ...
        for (var _x3 of [1, 2, 3, 4, 5]) {
          ...
          if (nodes.length > 0) {
            _this12.debug("post-processing vue_for tag ".concat(_x3, " (len:").concat(nodes.length, ")"));
            nodes.map(function (elem) {
              var cur = $(elem);
        ...
        if (common_methods.length > 0 || on_events.length > 0) {
          _this12.debug('post-processing methods (common, timer, and v-on element events methods)');
          ...
          common_methods.map(function (elem) {
            ...
            if (cur.attr('timer_time')) {
              _self.x_state.npm['vue-interval'] = '*';
    ...
    */
      ...
      $("*").filter((index, el) => {
        ...
        for (var key in attribs) {
          if (key.indexOf('_encrypt') > -1) {
            //decrypt into value
            var val = encrypt.decryptJSON(attribs[key], '123');
            var key_ = key.replace('_encrypt', '');
            original = original.replace("".concat(key, "=\"").concat(attribs[key], "\""), "".concat(key_, "={").concat(val, "}"));
    ...
    processLangPo(vue, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this13.x_state.central_config.idiomas.indexOf(',') != -1) {
          _this13.debug('process /lang/ po/mo files');
          var path = require('path'),
            fs = require('fs').promises;
          // .check and create directs if needed
          var lang_path = path.join(_this13.x_state.dirs.base, '/lang/');
          try {
          ...
          _this13.x_state.central_config.idiomas.split(',')[0];

          // .read other po/mo files from lang dir and convert to .js
          for (var idioma in _this13.x_state.central_config.idiomas.split(',')) {
          }
          //
        }
    ...
    createVueXStores() {
      var _this14 = this;
      return _asyncToGenerator(function* () {
        if (Object.keys(_this14.x_state.stores).length > 0) {
          ...
          for (var store_name in _this14.x_state.stores) {
            var store = _this14.x_state.stores[store_name];
            var file = path.join(_this14.x_state.dirs.store, "".concat(store_name, ".js"));
            var def_types = {
              'integer': 0,
              'int': 0,
              'float': 0.0,
            ...
            // expires?
            if (store_name in _this14.x_state.stores_types['expires']) {
              obj['expire'] = parseInt(_this14.x_state.stores_types['expires'][store_name]);
            }
            // versions?
            if (store_name in _this14.x_state.stores_types['versions']) {
              obj['version'] = parseInt(_this14.x_state.stores_types['versions'][store_name]);
            }
            // write content
            delete obj[':mutations'];
            var content = "export const state = () => (".concat(_this14.jsDump(obj), ")\n");
            // :mutations?
            ...
            // write file
            _this14.writeFile(file, content);
          }
        }
      })();
    }
    createServerMethods() {
      var _this15 = this;
      return _asyncToGenerator(function* () {
        if (Object.keys(_this15.x_state.functions).length > 0) {
          _this15.x_console.outT({
            message: "creating NuxtJS server methods",
            color: 'green'
          });
          var path = require('path');
          var file = path.join(_this15.x_state.dirs.server, "api.js");
          ...
          var imps = {};
          for (var x in _this15.x_state.functions) {
            for (var imp in _this15.x_state.functions[x]) {
              imps[imp] = _this15.x_state.functions[x][imp];
              yield _this15.setImmediatePromise(); //@improved
            }
          ...
          //declare app methods
          for (var func_name in _this15.x_state.functions) {
            var func = _this15.x_state.functions[func_name];
            var func_return = "";
    ...
    createMiddlewares() {
      var _this16 = this;
      return _asyncToGenerator(function* () {
        if (Object.keys(_this16.x_state.proxies).length > 0) {
          _this16.x_console.outT({
            message: "creating VueJS Middlewares",
            color: 'cyan'
          });
          var path = require('path');
          for (var proxy_name in _this16.x_state.proxies) {
            var proxy = _this16.x_state.proxies[proxy_name];
            var file = path.join(_this16.x_state.dirs.middleware, "".concat(proxy_name, ".js"));
            //add imports
            var content = "";
            ...
            for (var page_name in _this16.x_state.pages) {
              if (page_name != '') {
                var page = _this16.x_state.pages[page_name];
                if (page.path) {
    ...
    createSystemFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this17.writeFile(g('@theme/theme.js'), "import { createTheme } from '@mui/material/styles';\n\n        const appTheme = createTheme({\n          palette: {\n            mode: 'light',\n            primary: {\n              main: '#DCED71',\n            },\n            secondary: {\n              main: '#1E1F24'\n            },\n            tertiary: {\n              main: '#34414B'\n            }\n          },\n        });\n        \n        export default appTheme;");

        //create index.js
        _this17.writeFile(g('@src/index.js'), "import(\"./App\");\n");
        //create styles/globals.css
        //@todo grab values from main node 'styles'
        _this17.writeFile(g('@styles/globals.css'), "body {\n            font-family: Arial, Helvetica, sans-serif;\n          }\n          \n          .container {\n            font-size: 3rem;\n            margin: auto;\n            max-width: 800px;\n            margin-top: 20px;\n          }\n        ");
        ...
        if (_this17.x_state.config_node['html:meta']) {
          for (var meta_key in _this17.x_state.config_node['html:meta']) {
            if (meta_key.charAt(0) != ':') {
              var test = meta_key.toLowerCase().trim();
              var value = _this17.x_state.config_node['html:meta'][meta_key];
              if (test == 'charset') {
        ...
        for (var script in config.head.script) {
          ...
          meta_head += "<script ";
          for (var _key2 in script_tag) {
            meta_head += "".concat(_key2, "=\"").concat(script_tag[_key2], "\" ");
          }
          meta_head += "></script>\n";
        }
        //
        _this17.writeFile(g('@public/index.html'), "\n        <!DOCTYPE html>\n        <html lang=\"".concat(_this17.x_state.central_config.langs.split(',')[0], "\">\n        \n        <head>\n          <meta charset=\"UTF-8\">\n          <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n          <title>").concat(_this17.x_state.config_node['nuxt:title'] ? _this17.x_state.config_node['nuxt:title'] : _this17.x_state.central_config.apptitle, "</title>\n          <link\n            rel=\"stylesheet\"\n            href=\"https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap\"\n          />\n          <link\n            rel=\"stylesheet\"\n            href=\"https://fonts.googleapis.com/icon?family=Material+Icons\"\n          />\n          ").concat(meta_head, "\n        </head>\n        \n        <body>\n          <div id=\"app\"></div>\n        </body>\n        \n        </html>        \n        "));
        //create createEmotionCache.js
        _this17.writeFile(g('@utility/createEmotionCache.js'), "import createCache from '@emotion/cache';\n\n        const createEmotionCache = () => {\n          return createCache({ key: 'css', prepend: true });\n        };\n        \n        export default createEmotionCache;\n        ");
        //@pages/index.js created on onCreateFiles
        //create App.jsx
        //@todo obtain files and routes from map and use React Router
        _this17.writeFile(g('@src/App.jsx'), "import React from \"react\";\n        import ReactDOM from \"react-dom\";\n        import 'normalize.css';\n        import '@fontsource/roboto/300.css';\n        import '@fontsource/roboto/400.css';\n        import '@fontsource/roboto/500.css';\n        import '@fontsource/roboto/700.css';\n        \n        import { CacheProvider } from '@emotion/react';\n        import { ThemeProvider, CssBaseline } from '@mui/material';\n        import appTheme from './styles/theme/theme';\n        import createEmotionCache from './utility/createEmotionCache';\n\n        // @todo add a key for each main page\n        import { Home } from \"./pages\";\n\n        import \"./styles/globals.css\";\n        \n        const clientSideEmotionCache = createEmotionCache();\n\n        export const App = (props) => {\n        return (\n            <CacheProvider value={clientSideEmotionCache}>\n            <ThemeProvider theme={appTheme}>\n                <CssBaseline />\n                <div className=\"container\">\n                <Home/>\n                </div>\n            </ThemeProvider>\n            </CacheProvider>\n        )\n        };\n        ReactDOM.render(<App />, document.getElementById(\"app\"));\n        ");
        // create .babelrc
        _this17.writeFile(g('@app/.babelrc'), "{\n            \"presets\": [\"@babel/preset-react\", \"@babel/preset-env\"],\n            \"plugins\": [\n               [\"@babel/transform-runtime\"]\n            ]\n        }\n        ");
        // create webpack.config.js
        var webpack = {};
        webpack.template = "\n        const HtmlWebPackPlugin = require(\"html-webpack-plugin\");\n        const ModuleFederationPlugin = require(\"webpack/lib/container/ModuleFederationPlugin\");\n        \n        const path = require('path');\n        const deps = require(\"./package.json\").dependencies;\n        module.exports = {\n          output: {\n            publicPath: \"http://localhost:".concat(_this17.x_state.central_config.port, "/\",\n          },\n        \n          resolve: {\n            extensions: [\".tsx\", \".ts\", \".jsx\", \".js\", \".json\"],\n          },\n        \n          devServer: {\n            historyApiFallback: true,\n            static: {\n              directory: path.join(__dirname),\n            },\n            compress: true,\n            port: ").concat(_this17.x_state.central_config.port, ",\n            hot: true,\n            headers: {\n              'Access-Control-Allow-Origin': '*',\n              'Access-Control-Allow-Methods': 'GET, POST, PUT, DELETE, PATCH, OPTIONS',\n              'Access-Control-Allow-Headers': 'X-Requested-With, content-type, Authorization',\n            },\n          },\n        \n          module: {\n            rules: [\n              {\n                test: /.m?js/,\n                type: \"javascript/auto\",\n                resolve: {\n                  fullySpecified: false,\n                },\n              },\n              {\n                test: /.(css|s[ac]ss)$/i,\n                use: [\"style-loader\", \"css-loader\", \"postcss-loader\"],\n              },\n              {\n                test: /.(ts|tsx|js|jsx)$/,\n                exclude: /node_modules/,\n                use: {\n                  loader: \"babel-loader\",\n                },\n              },\n            ],\n          },\n        \n          plugins: [\n            new ModuleFederationPlugin({\n              name: \"").concat(_this17.x_state.central_config.apptitle, "\",\n              filename: \"remoteEntry.js\",\n              remotes: {\n              },\n              //@todo add components marked as 'shared'\n              exposes: {\n                './App': './src/App',\n                './Home': './src/pages/Home',\n              },\n              shared: {\n                ...deps,\n                react: {\n                  singleton: true,\n                  requiredVersion: deps.react,\n                },\n                \"react-dom\": {\n                  singleton: true,\n                  requiredVersion: deps[\"react-dom\"],\n                },\n              },\n            }),\n            new HtmlWebPackPlugin({webpack:html}),\n          ],\n        };        \n        ");
        //
        webpack.HtmlWebPackPlugin = {
          template: "./src/public/index.html"
        };
        // copy the 'favicon' file, and add it to HtmlWebPackPlugin node within webpack.config.js file
        if (_this17.x_state.config_node['favicon']) {
          // copy icon to static dir
          var _path2 = require('path');
          var source = _path2.join(_this17.x_state.dirs.base, _this17.x_state.config_node['favicon']);
          var target = _this17.x_state.dirs.static + 'icon.png'; //@todo get extension from source
        ...
        webpack.template = webpack.template.replace('{webpack:html}', _this17.jsDump(webpack.HtmlWebPackPlugin));
        // write file
        _this17.writeFile(g('@app/webpack.config.js'), webpack.template);
        ...
        var _loop2 = function _loop2(node_key) {
          if (node_key.includes(':') == false) {
            if ('aurora,vpc,aws'.split(',').includes(node_key) == false) {
              ...
              if (typeof _this17.x_state.config_node[node_key] === 'object') {
                Object.keys(_this17.x_state.config_node[node_key]).map(function (attr) {
        ...
        _this17.writeFile(g('@app/.env'), ini.stringify(env));
      })();
    }
    installRequiredPlugins() {
      var _this18 = this;
      return _asyncToGenerator(function* () {
        _this18.x_state.plugins['vuetify'] = {
          global: true,
          npm: {
            'node-sass': '*'
          },
        ...
        _this18.x_state.nuxt_config.build_modules['@nuxtjs/vuetify'] = {};
        _this18.x_state.plugins['aos'] = {
          global: true,
          npm: {
            aos: '*'
          },
        ...
        _this18.x_state.plugins['fontawesome'] = {
          global: true,
          npm: {
        ...
        //support for tawk.io
        if (_this18.x_state.config_node.tawk && _this18.x_state.config_node.tawk.propertyId && _this18.x_state.config_node.tawk.widgetId) {
          _this18.x_state.plugins['tawk'] = {
            global: true,
            npm: {
              '@tawk.to/tawk-messenger-vue': '*'
            },
            mode: 'client',
            customcode: "import Vue from \"vue\";\n                import TawkMessengerVue from '@tawk.to/tawk-messenger-vue';\n\n                export default function () {\n                    Vue.use(TawkMessengerVue, {\n                        propertyId : '".concat(_this18.x_state.config_node.tawk.propertyId, "',\n                        widgetId : '").concat(_this18.x_state.config_node.tawk.widgetId, "'\n                    });\n                }")
          };
        }
      })();
    }
    createNuxtPlugins() {
      ...
      return _asyncToGenerator(function* () {
        ...
        for (var plugin_key in _this19.x_state.plugins) {
          var plugin = _this19.x_state.plugins[plugin_key];
          if (typeof plugin === 'object') {
            // copy x_state_plugins npm's into npm global imports (for future package.json)
            if (plugin.npm) _this19.x_state.npm = _objectSpread2(_objectSpread2({}, _this19.x_state.npm), plugin.npm);
            if (plugin.dev_npm) _this19.x_state.dev_npm = _objectSpread2(_objectSpread2({}, _this19.x_state.dev_npm), plugin.dev_npm);
            ...
            if (plugin.styles) {
              for (var style_key in plugin.styles) {
                ...
                if (style.file.includes('/') == false) {
                  var target = path.join(_this19.x_state.dirs.css, style.file);
                  yield _this19.writeFile(target, style.content);
                  resp.css_files.push({
            ...
            if (plugin.config) {
              if (typeof plugin.config === 'object') {
                _code += "const config = ".concat(_this19.jsDump(plugin.config), ";\n                        Vue.use(").concat(import_as, ",config);");
              } else {
            ...
            if (import_as != 'vuetify') {
              ...
              var _target = path.join(_this19.x_state.dirs.plugins, "".concat(import_as, ".js"));
              if (write) yield _this19.writeFile(_target, _code);
            }
            ...
            //simple plugin
            _this19.x_state.npm[plugin_key] = plugin;
            ...
            if (_import_as != 'vuetify') {
              ...
              var _target2 = path.join(_this19.x_state.dirs.plugins, "".concat(_import_as, ".js"));
              if (write) yield _this19.writeFile(_target2, code);
            }
            //10-ago-21 assign code to plugin registry (for storybook)
            resp.stories[plugin_key] = plugin;
    ...
    createNuxtConfig() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var path = require('path');
        var target = path.join(_this20.x_state.dirs.app, "nuxt.config.js");
        _this20.x_state.central_config[':mode'] == 'spa' ? true : false;
        if (_this20.x_state.central_config[':ssr']) _this20.x_state.central_config[':ssr'];
        var target_val = _this20.x_state.central_config.static == true ? 'static' : 'server';
        _this20.x_state.central_config.deploy + '';
        var config = {
          ssr: true,
          ...
          head: {
            title: _this20.x_state.config_node['nuxt:title'] ? _this20.x_state.config_node['nuxt:title'] : _this20.x_state.central_config.apptitle,
            meta: [],
            link: [
        ...
        if (_this20.x_state.central_config.static == true) {
          config.ssr = false;
          config.performance.gzip = false;
        }
        //add title:meta data
        if (_this20.x_state.config_node['nuxt:meta']) {
          for (var meta_key in _this20.x_state.config_node['nuxt:meta']) {
            if (meta_key.charAt(0) != ':') {
              var test = meta_key.toLowerCase().trim();
              var value = _this20.x_state.config_node['nuxt:meta'][meta_key];
              if (test == 'charset') {
                config.head.meta.push({
                  charset: value
                });
        ...
        } else if (_this20.x_state.config_node.meta && _this20.x_state.config_node.meta.length > 0) {
          config.head.meta = _this20.x_state.config_node.meta;
        }
        //add custom head scripts
        //sort head scripts a-z
        var as_array = [];
        for (var head in _this20.x_state.head_script) {
          as_array.push({
            key: head,
            params: _this20.x_state.head_script[head]
          });
          //config.head.script.push({ ...this.x_state.head_script[head] });
        }
        ...
        //nuxt axios config
        if (_this20.x_state.config_node.axios) {
          var ax_config = {
            proxy: _this20.x_state.nuxt_config.modules['@nuxtjs/proxy'] ? true : false
          };
          ax_config = _objectSpread2(_objectSpread2({}, _this20.x_state.config_node.axios), ax_config);
          if (ax_config.retries) {
            ax_config.retry = {
              retries: ax_config.retries
            };
            delete ax_config.retries;
            _this20.x_state.npm['axios-retry'] = '*';
          }
          /*
        ...
        //nuxt vue config
        if (_this20.x_state.config_node['vue:config']) {
          config.vue = {
            config: _this20.x_state.config_node['vue:config']
          };
          delete config.vue.config[':secret'];
          delete config.vue.config[':link'];
        }
        //nuxt proxy config keys
        if (_this20.x_state.nuxt_config.modules['@nuxtjs/proxy']) {
          config.proxy = _this20.x_state.nuxt_config.modules['@nuxtjs/proxy'];
        }
        //nuxt env variables
        config.publicRuntimeConfig = {};
        for (var node_key in _this20.x_state.config_node) {
          if (node_key.includes(':') == false) {
            if ('aurora,vpc,aws'.split(',').includes(node_key) == false) {
              if (_this20.x_state.secrets[node_key] === undefined && typeof _this20.x_state.config_node[node_key] === 'object') {
                config.publicRuntimeConfig[node_key.toLowerCase()] = _objectSpread2({}, _this20.x_state.config_node[node_key]);
              }
            }
          }
        }
        //nuxt google:analytics
        if (_this20.x_state.config_node['google:analytics']) {
          if (_this20.x_state.config_node['google:analytics'].local && _this20.x_state.config_node['google:analytics'].local == true) {
            config.debug = true;
          }
        }
        //nuxt modules
        for (var module_key in _this20.x_state.nuxt_config.modules) {
          var module = _this20.x_state.nuxt_config.modules[module_key];
        ...
        //nuxt build_modules
        for (var _module_key in _this20.x_state.nuxt_config.build_modules) {
          var _module = _this20.x_state.nuxt_config.build_modules[_module_key];
        ...
        //nuxt plugins
        config.plugins = _this20.x_state.nuxt_config.plugins;
        config.css = _this20.x_state.nuxt_config.css;
        //muxt server methods
        if (_this20.x_state.functions && Object.keys(_this20.x_state.functions).length > 0) config.serverMiddleware = ['~/server/api'];
        ...
        if (_this20.x_state.central_config.stage && _this20.x_state.central_config.stage != 'production' && _this20.x_state.central_config.stage != 'prod') {
          config.build.publicPath = "/".concat(_this20.x_state.central_config.stage, "/_nuxt/");
        }
        ...
        if (_this20.deploy_module.modifyNuxtConfig) {
          config = yield _this20.deploy_module.modifyNuxtConfig(config);
        }
        var content = _this20.jsDump(config).replaceAll("'`", "`").replaceAll("`'", "`");
        yield _this20.writeFile(target, "export default ".concat(content));
    ...
    createPackageJSON() {
      ...
      return _asyncToGenerator(function* () {
        var data = {
          name: _this21.x_state.central_config.service_name,
          version: '',
          description: _this21.x_state.central_config[':description'],
          //main: 'index.js',
          dependencies: {},
          devDependencies: {},
          scripts: {
            ...
            'build:start': "cd dist && PORT=".concat(_this21.x_state.central_config.port, " npx serve"),
        ...
        if (_this21.x_state.central_config[':version']) data.version = _this21.x_state.central_config[':version'];
        if (_this21.x_state.central_config[':author']) data.author = _this21.x_state.central_config[':author'];
        if (_this21.x_state.central_config[':license']) data.license = _this21.x_state.central_config[':license'];
        if (_this21.x_state.central_config[':git']) {
          data.repository = {
            type: 'git',
            url: "git+".concat(_this21.x_state.central_config[':git'], ".git")
          };
          data.bugs = {
            url: "".concat(_this21.x_state.central_config[':git'], "/issues")
          };
          data.homepage = _this21.x_state.central_config[':git'];
        }
        if (_this21.x_state.central_config[':keywords']) data.keywords = _this21.x_state.central_config[':keywords'].split(',');
        //add dependencies
        for (var pack in _this21.x_state.npm) {
          if (_this21.x_state.npm[pack].includes('http') && _this21.x_state.npm[pack].includes('github.com')) {
            data.dependencies[pack] = "git+".concat(_this21.x_state.npm[pack]);
          } else {
            data.dependencies[pack] = _this21.x_state.npm[pack];
          }
        }
        //add devDependencies
        for (var _pack in _this21.x_state.dev_npm) {
          if (_this21.x_state.dev_npm[_pack].includes('http') && _this21.x_state.dev_npm[_pack].includes('github.com')) {
            data.devDependencies[_pack] = "git+".concat(_this21.x_state.dev_npm[_pack]);
          } else {
            data.devDependencies[_pack] = _this21.x_state.dev_npm[_pack];
          }
        }
        //storybook support
        /*
        ...
        //write to disk
        var path = require('path');
        var target = path.join(_this21.x_state.dirs.app, "package.json");
        if (_this21.deploy_module.modifyPackageJSON) {
          data = yield _this21.deploy_module.modifyPackageJSON(data);
        }
        var content = JSON.stringify(data);
        yield _this21.writeFile(target, content);
    ...
    createStorybookFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this22.x_state.central_config.storybook == true) {
          var path = require('path');
          var spawn = require('await-spawn');
          var spinner = _this22.x_console.spinner({
            message: 'Installing storybook'
          });
          try {
            var install = yield spawn('npx', ['sb', 'init', '-f'], {
              cwd: _this22.x_state.dirs.app
            });
          ...
          var target = path.join(_this22.x_state.dirs['storybook'], "main.js");
          ...
          target = path.join(_this22.x_state.dirs['storybook'], "preview.js");
          yield _this22.writeFile(target, content);
          ...
          target = path.join(_this22.x_state.dirs['storybook'], "preview-head.html");
          yield _this22.writeFile(target, content);
          // creates custom Theme
          // copy po logo
          var po_logo = path.join(__dirname, 'assets', 'po.png');
          var po_target = path.join(_this22.x_state.dirs['stories_assets'], 'po.png');
          var fs = require('fs-extra');
          yield fs.copy(po_logo, po_target);
          // remove original stories
          //let fso = require('fs').promises;
          yield fs.rmdir(_this22.x_state.dirs['stories'].replace('stories2', 'stories'), {
            recursive: true
          });
          // copy stories2 to stories folder
          yield fs.copy(_this22.x_state.dirs['stories'], _this22.x_state.dirs['stories'].replace('stories2', 'stories'));
          yield fs.rmdir(_this22.x_state.dirs['stories'], {
            recursive: true
          });
          ...
          target = path.join(_this22.x_state.dirs['storybook'], "po.js");
          yield _this22.writeFile(target, content);
          ...
          target = path.join(_this22.x_state.dirs['storybook'], "manager.js");
          yield _this22.writeFile(target, content);
        }
      })();
    }
    createVSCodeHelpers() {
      ...
      return _asyncToGenerator(function* () {
        ...
        //write to disk
        var target = path.join(_this23.x_state.dirs.app, "jsconfig.json");
        var content = JSON.stringify(data);
    ...
    createServerlessYML() {
      ...
      return _asyncToGenerator(function* () {
        var yaml = require('yaml'),
          data = {};
        var deploy = _this24.x_state.central_config.deploy + '';
        if (deploy.includes('eb:') == false && deploy.includes('s3:') == false && deploy != false && deploy != 'local') {
          data.service = _this24.x_state.central_config.service_name;
          data.custom = {
            prune: {
              automatic: true,
              includeLayers: true,
          ...
          for (var secret in _this24.x_state.secrets) {
            data.custom[secret] = '${file(secrets/' + secret + '.json)}';
          }
          //domain info
          if (_this24.x_state.central_config.dominio) {
            data.custom.customDomain = {
              domainName: _this24.x_state.central_config.dominio
            };
            if (_this24.x_state.central_config.basepath) data.custom.customDomain.basePath = _this24.x_state.central_config.basepath;
            if (_this24.x_state.central_config.stage) data.custom.customDomain.stage = _this24.x_state.central_config.stage;
          ...
          data.provider = {
            name: 'aws',
            runtime: 'nodejs8.10',
            timeout: _this24.x_state.central_config.timeout
          };
          if (_this24.x_state.central_config.stage) data.provider.stage = _this24.x_state.central_config.stage;
          //env keys
          if (Object.keys(_this24.x_state.config_node) != '') {
            data.provider.enviroment = {};
            if (_this24.x_state.central_config.stage) data.provider.enviroment.STAGE = _this24.x_state.central_config.stage;
            if (_this24.x_state.config_node.vpc) {
              data.provider.vpc = {
                securityGroupIds: [_this24.x_state.config_node.vpc.security_group_id],
                subnetIDs: []
              };
              if (_this24.x_state.secrets.vpc) {
                data.provider.vpc.securityGroupIds = ['${self:custom.vpc.SECURITY_GROUP_ID}'];
              }
              if (_this24.x_state.config_node.vpc.subnet1_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET1_ID}');
              if (_this24.x_state.config_node.vpc.subnet2_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET2_ID}');
              if (_this24.x_state.config_node.vpc.subnet3_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET3_ID}');
              if (_this24.x_state.config_node.vpc.subnet4_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET4_ID}');
              if (_this24.x_state.config_node.vpc.subnet5_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET5_ID}');
              if (_this24.x_state.config_node.vpc.subnet6_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET6_ID}');
              if (_this24.x_state.config_node.vpc.subnet7_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET7_ID}');
            }
          }
          ...
          if (_this24.x_state.central_config['keep-warm']) {
          ...
          if (_this24.x_state.central_config.dominio) data.plugins.push('serverless-domain-manager');
          //write yaml to disk
          var content = yaml.stringify(data);
          var path = require('path');
          var target = path.join(_this24.x_state.dirs.app, "serverless.yml");
    ...
    onEnd() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this25.errors_found) {
          //only deploy if no errors were found
          if (!(yield _this25.deploy_module.deploy())) {
            _this25.x_console.outT({
              message: 'Something went wrong deploying, check the console, fix it and run again.',
              color: 'red'
            });
            yield _this25.deploy_module.post();
    ...
    writeFile(file, content) {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this26.debug('writeFile:' + file + ' (ext:' + ext + ')');
        ...
        if (ext == 'jsx') {
          try {
            ...
            _this26.debug("error: could not format the JS file; trying js-beautify");
          ...
          try {
            ...
            _this26.debug("error: could not format the JSON file; trying js-beautify");
          ...
          try {
            ...
            _this26.debug("warning: could not format the html file; trying vue-beautify", ee);
        ...
        var target_exists = yield _this26.exists(file);
        var same = false;
        if (target_exists) {
          var prev = yield fs.readFile(file, encoding);
          var prev_hash = yield _this26.hash(prev);
          var curr_hash = yield _this26.hash(resp);
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (page_exports != '') _this27.writeFile(_this27.g('@pages/index.js'), page_exports);
        if (comp_exports != '') _this27.writeFile(_this27.g('@components/index.js'), comp_exports);
        ...
        _this27.debug('processing nodes');
        require('fs').promises;
          var path = require('path');
        for (var _thefile_num in processedNodes) {
          //await processedNodes.map(async function(thefile) {
          var _thefile = processedNodes[_thefile_num]; // only level 2 nodes!
          _thefile.code + '\n';
          ...
          //
          if (_thefile.file.split('.').slice(-1) == 'omit') ; else if (_thefile.file.includes('.group') == true) {
            yield* function* () {
              _this27.x_console.outT({
                message: "segmenting 'group' file ".concat(_thefile.file),
                color: 'cyan'
              });
              //console.log('@TODO pending support for "grouped" components');
              //extract react_file tags
              _this27.debug('processing group ' + _thefile.file + ' of files', _thefile);
              var cheerio = require('cheerio');
              var $ = cheerio.load(_thefile.code, {
                ignoreWhitespace: false,
                xmlMode: true,
                decodeEntities: false
              });
              ...
              for (var tobe of tobe_created) {
                var the_node = yield _this27.dsl_parser.getNode({
                  id: tobe.id,
                  recurse: false
                });
                tobe.title = yield _this27.onDefineTitle(the_node);
                tobe.file = yield _this27.onDefineFilename(the_node);
            ...
            yield toDisk(_thefile);
          }
          //this.x_console.out({ message:'pages debug', data:this.x_state.pages });
          yield _this27.setImmediatePromise(); //@improved
        }
        // *************************
        ...
        // copy assets
        if (Object.keys(_this27.x_state.assets).length > 0) {
          _this27.debug({
            message: "Copying assets",
            color: 'cyan'
          });
          var copy = require('recursive-copy');
          for (var i in _this27.x_state.assets) {
            //@TODO add support for i18n assets
            var asset = _this27.x_state.assets[i];
            if (!asset.i18n) {
              var source = path.join(_this27.x_state.dirs.base, asset.original);
              var target = path.join(_this27.x_state.dirs.assets, asset.original.split('/').slice(-1)[0]);
        ...
        yield _this27.createSystemFiles();
    ...
    _isLocalServerRunning() {
      ...
      return _asyncToGenerator(function* () {
        var is_reachable = require('is-port-reachable');
        var resp = yield is_reachable(_this28.x_state.central_config.port);
        return resp;
      })();
    }
    ...
    _readModels() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this29.debug('_readModels');
        _this29.debug_time({
          id: 'readModels'
        });
        var modelos = yield _this29.dsl_parser.getNodes({
          text: 'models',
          level: 2,
          icon: 'desktop_new',
          recurse: true
        ...
        var tmp = {
            appname: _this29.x_state.config_node.name
          },
          fields_map = {};
        var resp = {
          tables: {},
        ...
        if (modelos.length > 0) {
          ...
          for (var table of modelos[0].nodes) {
            ...
            yield _this29.setImmediatePromise(); //@improved
          }
        }

        _this29.debug_timeEnd({
          id: 'readModels'
        });
    ...
    _readAssets() {
      ...
      return _asyncToGenerator(function* () {
        var resp = {},
          path = require('path');
        _this30.debug('_readAssets');
        _this30.debug_time({
          id: '_readAssets'
        });
        var assets = yield _this30.dsl_parser.getNodes({
          text: 'assets',
          level: 2,
          icon: 'desktop_new',
          recurse: true
    ...
    _readCentralConfig() {
      var _this31 = this;
      return _asyncToGenerator(function* () {
        _this31.debug('_readCentralConfig');
        var central = yield _this31.dsl_parser.getNodes({
          level: 1,
          recurse: false
        });
        ...
        if (!resp[':cache']) _this31.x_config.cache = false; // disables cache when processing nodes (@todo)
        //@temp 23nov22
        if (resp['ui'] == 'mui') {
          // add autocomplete definitions for all MUI components
          // just a demo for now
          yield _this31.addAutocompleteDefinition({
            text: 'AppBar',
            icons: ['idea'],
            level: [3, 4],
            ...
            attributes: {
              'color': {
                ...
                hint: 'Defines the color of the AppBar'
              }
            }
          });
        }
        ...
        if (resp['ui'] == 'mui') {
          _this31.x_state.ui = _objectSpread2(_objectSpread2(_objectSpread2({}, _this31.x_state.ui), uiDefaultState), {
            'textTag': 'Typography',
    ...
    _readConfig() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = {
          ...
          config_node = {};
        var search = yield _this32.dsl_parser.getNodes({
          text: 'config',
          level: 2,
          icon: 'desktop_new',
          recurse: true
        ...
        if (search.length > 0) {
            ...
            if (key.text.toLowerCase() == 'meta') {
              for (var meta_child of key.nodes) {
                ...
                if (meta_child.text.toLowerCase() == 'keywords') {
                  ...
                  resp.meta.push({
                    hid: yield _this32.hash(meta_child.nodes[0].text),
                    name: 'keywords',
              ...
              resp = _objectSpread2(_objectSpread2({}, resp), _this32.configFromNode(resp, key));
              //
            }
          }
          ...
          var central2 = JSON.parse(JSON.stringify(_this32.x_state.central_config));
          for (var _key3 in resp) {
            if (typeof resp[_key3] === 'object') {
              for (var key2 in resp[_key3]) {
                if (typeof resp[_key3][key2] === 'string' && resp[_key3][key2].indexOf('${') != -1 && resp[_key3][key2].indexOf('}') != -1) {
                  var to_eval = resp[_key3][key2];
        ...
        if (!resp.name) {
          var path = require('path');
          var dsl_folder = path.dirname(path.resolve(_this32.x_flags.dsl));
          var parent_folder = path.resolve(dsl_folder, '../');
          var folder = dsl_folder.replace(parent_folder, '');
          resp.name = folder.replace('/', '').replace('\\', '') + '_' + path.basename(_this32.x_flags.dsl, '.dsl');
    ...
    getParentNodes() {
      var _arguments4 = arguments,
        _this33 = this;
      return _asyncToGenerator(function* () {
        var id = _arguments4.length > 0 && _arguments4[0] !== undefined ? _arguments4[0] : _this33.throwIfMissing('id');
        var exec = _arguments4.length > 1 && _arguments4[1] !== undefined ? _arguments4[1] : false;
        var parents = yield _this33.dsl_parser.getParentNodesIDs({
          id,
          array: true
        });
        var resp = [];
        for (var parent_id of parents) {
          var node = yield _this33.dsl_parser.getNode({
            id: parent_id,
            recurse: false
          });
          var command = yield _this33.findValidCommand({
            node,
            object: exec
          });
    ...
    struct2params() {
      ...
      for (var [key, value] of Object.entries(tmp)) {
        if (value == null) {
          ...
          //serialize value
          var encrypt = require('encrypt-with-password');
          var val = encrypt.encryptJSON(this.jsDump(value), '123');
          resp.push("".concat(key, "_encrypt=\"").concat(val, "\""));
        }
      }
      return resp.join(' ');
    }
    ...
    hash(thing) {
      var _this34 = this;
      return _asyncToGenerator(function* () {
        var resp = yield _this34.dsl_parser.hash(thing);
