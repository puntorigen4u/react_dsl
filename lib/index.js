  ...
  class react_dsl extends concepto {
    ...
    getBasicReact(thefile) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (page) {
          ...
          if (page.tipo == 'componente' && page.params != '') {
            _this11.debug('- declare componente:props');
            if (react.first) react.script += ',\n';
            react.first = true;
            var isNumeric = function isNumeric(n) {
              return !isNaN(parseFloat(n)) && isFinite(n);
          ...
          if (Object.keys(page.variables) != '') {
            ...
            for (var key in page.variables) {
              var def_val = page.variables[key] ? "'".concat(page.variables[key], "'") : "''";
        ...
        for (var plugin_key in _this19.x_state.plugins) {
          ...
          if (typeof plugin === 'object') {
            ...
            if (import_as != 'vuetify') {
              ...
              var _target2 = path.join(_this19.x_state.dirs.plugins, "".concat(import_as, ".js"));
              if (write) yield _this19.writeFile(_target2, _code);
            }
            ...
            if (_import_as != 'vuetify') {
              ...
              var _target3 = path.join(_this19.x_state.dirs.plugins, "".concat(_import_as, ".js"));
              if (write) yield _this19.writeFile(_target3, code);
            }
            //10-ago-21 assign code to plugin registry (for storybook)
            resp.stories[plugin_key] = plugin;
    ...
    onEnd() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this25.errors_found) {
          ...
          if (!(yield _this25.deploy_module.deploy()) && !_this25.x_state.central_config.componente) {
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (page_exports != '') {
          _this27.writeFile(_this27.g('@pages/index.js'), page_exports);
        }
          ...
          var toDisk = /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator(function* (thefile) {
              ...
              if (page.params == '') {
                ...
                react.script = react.script.replaceAll('{concepto:attributes}', "{ ".concat(page.params.split(',').push('children').join(','), " }"));
              }
              // **** **** end script wrap **** **** 
              // process Mixins
              ...
              yield this.writeFile(w_path, react.full);
              //
