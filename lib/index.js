  ...
  var autocomplete$1 = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (parent) {
      ...
      components.Box = _objectSpread2(_objectSpread2({}, types.base), {
        ...
        attributes: _objectSpread2(_objectSpread2({}, systemProp), {
          '{icon:list}sx': {
            type: 'object',
      ...
      var _loop = function* _loop(style) {
        components['icon:' + style + ':'] = _objectSpread2(_objectSpread2({}, types.base), {
        ...
        yield parent.addCommand({
          ["def_icon_".concat(style.toLowerCase())]: {
            x_level: '>3',
            x_icons: 'idea',
      ...
      components.LoadingButton = _objectSpread2(_objectSpread2({}, components.Button), {
  ...
  class react_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this3.x_state.dev_npm['@babel/babel-plugin-direct-import'] = '^7.15.8';
    ...
    processInternalTags(react, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (nodes.length > 0) _this12.debug('post-processing def_param tags');
        var self = _this12;
        ...
        for (var i = 0; i < nodes.length; i++) {
          ...
          if (target_node.length != -1) {
            ...
            if (cur.attr('is_function')) {
              ...
              val = self.serializeComplexAttr("()=>{ ".concat(cur.html(), " }"));
    ...
    createSystemFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var babel_ = yield _this17.x_theme.BabelRC(default_babel);
        _this17.writeFile(g('@app/.babelrc'), JSON.stringify(babel_));
